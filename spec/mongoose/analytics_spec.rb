  ...
  class Analytics
    describe Analytics do
      ...
      describe '#respond_to?' do
        it 'responds to all public instance methods of Mongoose::Analytics::Client' do
          expect(analytics).to respond_to(*Mongoose::Analytics::Client.public_instance_methods(false))
        end
      end

      describe '#method' do
        Mongoose::Analytics::Client.public_instance_methods(false).each do |public_method|
