module Mongoose
  class Analytics
    # Handles parsing fields according to the Mongoose Spec
    #
    # @see https://mongoose.com/docs/spec/
    class FieldParser
      class << self
        ...
        def add_context!(context)
          context[:library] = { :name => 'mongoose-ruby', :version => Mongoose::Analytics::VERSION.to_s }
        end
